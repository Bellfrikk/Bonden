type traktorModellar = 'Dexta';


class Traktor extends MaskinKjoretoyMal {
  grafikk: {
      dekkVB: GrafikkDelDekk,
      dekkHB: GrafikkDelDekk,
      dekkVF: GrafikkDelDekkMedSving,
      dekkHF: GrafikkDelDekkMedSving,
...
interface TraktorData extends MaskinKjoretoyData {
  grafikk: {
      dekkVB: GrafikkDelDekk,
      dekkHB: GrafikkDelDekk,
      dekkVF: GrafikkDelDekkMedSving,
...
const traktorDexta: TraktorData = {
