...
class Skurtreskar extends MaskinKjoretoyMal {
  grafikk: {
    ...
    royr: GrafikkDelRetning,
  }

  constructor (ny:SkurtreskarData, rute:Posisjon){
    super(ny, rute)
    this.grafikk = {
...
interface SkurtreskarData extends MaskinKjoretoyData {
  grafikk: {
      dekkVB: GrafikkDelDekkMedSving,
      dekkHB: GrafikkDelDekkMedSving,
      dekkVF: GrafikkDelDekk,
